...
class PlusSwitch extends StatefulWidget {
  ...
  const PlusSwitch({
    ...
    this.hoverColor,
    this.focusNode,
    this.autofocus = false, this.kTrackHeight, this.kTrackWidth,
...
//  double kTrackRadius = kTrackHeight / 2.0;
//  double kThumbRadius = 6;
//  double kSwitchWidth = kTrackWidth - 2 * kTrackRadius + 2 * kRadialReactionRadius;
//  double kSwitchHeight = 2 * kRadialReactionRadius + 8.0;
//  double kSwitchHeightCollapsed = 2 * kRadialReactionRadius;
  ...
  double getSwitchWidth(){
    return  kTrackWidth - 2 * getTrackRadius() + 2 * kRadialReactionRadius;
  }

  double getThumbRadius(){
...
class _SwitchState extends State<PlusSwitch> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    print("_kTrackHeight=="+widget.kTrackHeight.toString());
  ...
  Size getSwitchSize(ThemeData theme) {
    switch (widget.materialTapTargetSize ?? theme.materialTapTargetSize) {
      case MaterialTapTargetSize.padded:
        return  Size(widget.getSwitchWidth(), _kSwitchHeight);
        break;
      case MaterialTapTargetSize.shrinkWrap:
        return  Size(widget.getSwitchWidth(), _kSwitchHeightCollapsed);
        break;
    }
    assert(false);
    return null;
      ...
      child: Builder(
        builder: (BuildContext context) {
          return _SwitchRenderObjectWidget(
            ...
            hovering: _hovering,
            vsync: this,
            kTrackRadius: widget.getTrackRadius(),
            kTrackHeight: widget.kTrackHeight,
            kThumbRadius: widget.getThumbRadius(),
          );
        },
      ),
    );
...
class _SwitchRenderObjectWidget extends LeafRenderObjectWidget {
  ...
  void updateRenderObject(BuildContext context, _RenderSwitch renderObject) {
    renderObject
      ...
      ..dragStartBehavior = dragStartBehavior
      ..hasFocus = hasFocus
      ..hovering = hovering..kTrackHeight=kTrackHeight
      ..kTrackRadius=kTrackRadius..kThumbRadius=kThumbRadius
      ..vsync = vsync;
  }
}
...
class _RenderSwitch extends RenderToggleable {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final Paint paint = Paint()
      ..color = trackColor;
    double trackHorizontalPadding = kRadialReactionRadius - kTrackRadius;
    ...
    final RRect trackRRect = RRect.fromRectAndRadius(trackRect,  Radius.circular(kTrackRadius));
    ...
    try {
      ...
      final double radius = kThumbRadius - inset;
      thumbPainter.paint(
        canvas,
